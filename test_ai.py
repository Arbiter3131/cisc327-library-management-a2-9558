...
@patch('library_service.get_book_by_isbn', return_value={'title': 'Existing'})
...
@patch('library_service.get_book_by_id', return_value={'available_copies': 0})
...
@patch('library_service.get_book_by_id', return_value={'available_copies': 2, 'title': 'Test'})
...
@patch('library_service.get_book_by_id', return_value={'title': 'Test', 'book_id': 1})
@patch('library_service.get_patron_borrowed_books', return_value=[{'title': 'Test','book_id': 1}])
@patch('library_service.update_book_availability', return_value=True)
...
@patch('library_service.get_book_by_id', return_value={'title': 'Test'})
@patch('library_service.get_patron_borrowed_books', return_value=[{'book_id': 2}])
...
@patch('library_service.get_patron_history', return_value=[])
